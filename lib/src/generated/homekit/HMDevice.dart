...
/// Static methods for Objective-C class `HMDevice`.
/// See also instance methods in [HMDevicePointer].
///
...
/// Instance methods for [HMDevice] (Objective-C class `HMDevice`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/homekit?language=objc](https://developer.apple.com/documentation/homekit?language=objc)
extension HMDevicePointer on Pointer<HMDevice> {
  /// Objective-C method `IDSDeviceForIDSService:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `idsIdentifier`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setRapportIRK:`.
  @ObjcMethodInfo(
