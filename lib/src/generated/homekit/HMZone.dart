...
/// Static methods for Objective-C class `HMZone`.
/// See also instance methods in [HMZonePointer].
///
...
/// Instance methods for [HMZone] (Objective-C class `HMZone`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/homekit?language=objc](https://developer.apple.com/documentation/homekit?language=objc)
extension HMZonePointer on Pointer<HMZone> {
  /// Objective-C method `addRoom:completionHandler:`.
  @ObjcMethodInfo(
