...
/// Static methods for Objective-C class `HMMediaSystemRole`.
/// See also instance methods in [HMMediaSystemRolePointer].
///
...
/// Instance methods for [HMMediaSystemRole] (Objective-C class `HMMediaSystemRole`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/homekit?language=objc](https://developer.apple.com/documentation/homekit?language=objc)
extension HMMediaSystemRolePointer on Pointer<HMMediaSystemRole> {
  ...
  /// Objective-C method `initWithRole:`.
  @ObjcMethodInfo(
