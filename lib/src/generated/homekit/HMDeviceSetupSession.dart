...
/// Static methods for Objective-C class `HMDeviceSetupSession`.
/// See also instance methods in [HMDeviceSetupSessionPointer].
///
...
/// Instance methods for [HMDeviceSetupSession] (Objective-C class `HMDeviceSetupSession`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/homekit?language=objc](https://developer.apple.com/documentation/homekit?language=objc)
extension HMDeviceSetupSessionPointer on Pointer<HMDeviceSetupSession> {
  ...
  /// Objective-C method `initWithRole:delegate:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `sendExchangeData:completionHandler:`.
  @ObjcMethodInfo(
