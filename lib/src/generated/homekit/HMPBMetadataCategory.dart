...
/// Static methods for Objective-C class `HMPBMetadataCategory`.
/// See also instance methods in [HMPBMetadataCategoryPointer].
///
...
/// Instance methods for [HMPBMetadataCategory] (Objective-C class `HMPBMetadataCategory`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/homekit?language=objc](https://developer.apple.com/documentation/homekit?language=objc)
extension HMPBMetadataCategoryPointer on Pointer<HMPBMetadataCategory> {
  ...
  /// Objective-C method `setHasNumber:`.
  @ObjcMethodInfo(
