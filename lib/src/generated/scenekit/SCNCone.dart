...
/// Static methods for Objective-C class `SCNCone`.
/// See also instance methods in [SCNConePointer].
///
...
/// Instance methods for [SCNCone] (Objective-C class `SCNCone`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/scenekit?language=objc](https://developer.apple.com/documentation/scenekit?language=objc)
extension SCNConePointer on Pointer<SCNCone> {
  /// Objective-C method `bottomRadius`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `presentationCone`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setBottomRadius:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setTopRadius:`.
  @ObjcMethodInfo(
