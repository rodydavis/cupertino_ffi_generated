...
/// Static methods for Objective-C class `SCNPyramid`.
/// See also instance methods in [SCNPyramidPointer].
///
...
/// Instance methods for [SCNPyramid] (Objective-C class `SCNPyramid`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/scenekit?language=objc](https://developer.apple.com/documentation/scenekit?language=objc)
extension SCNPyramidPointer on Pointer<SCNPyramid> {
  ...
  /// Objective-C method `presentationPyramid`.
  @ObjcMethodInfo(
