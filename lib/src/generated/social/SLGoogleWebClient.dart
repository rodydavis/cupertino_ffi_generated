...
/// Static methods for Objective-C class `SLGoogleWebClient`.
/// See also instance methods in [SLGoogleWebClientPointer].
///
...
/// Instance methods for [SLGoogleWebClient] (Objective-C class `SLGoogleWebClient`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/social?language=objc](https://developer.apple.com/documentation/social?language=objc)
extension SLGoogleWebClientPointer on Pointer<SLGoogleWebClient> {
  ...
  /// Objective-C method `fallbackUserInfoURL`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `fallbackWebUserInfoResponseClass`.
  @ObjcMethodInfo(
