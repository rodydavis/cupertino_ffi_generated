...
/// Static methods for Objective-C class `SLTwitterSession`.
/// See also instance methods in [SLTwitterSessionPointer].
///
...
/// Instance methods for [SLTwitterSession] (Objective-C class `SLTwitterSession`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/social?language=objc](https://developer.apple.com/documentation/social?language=objc)
extension SLTwitterSessionPointer on Pointer<SLTwitterSession> {
  ...
  /// Objective-C method `retweetTweetWithID:completion:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `sendDirectMessage:toUser:withScreenName:completion:`.
  @ObjcMethodInfo(
