...
/// Static methods for Objective-C class `SLTencentWeiboSession`.
/// See also instance methods in [SLTencentWeiboSessionPointer].
///
...
/// Instance methods for [SLTencentWeiboSession] (Objective-C class `SLTencentWeiboSession`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/social?language=objc](https://developer.apple.com/documentation/social?language=objc)
extension SLTencentWeiboSessionPointer on Pointer<SLTencentWeiboSession> {
  ...
  /// Objective-C method `revokeAccessTokenForAppWithOauthToken:completion:`.
  @ObjcMethodInfo(
