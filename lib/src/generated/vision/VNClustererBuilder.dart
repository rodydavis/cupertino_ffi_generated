...
/// Static methods for Objective-C class `VNClustererBuilder`.
/// See also instance methods in [VNClustererBuilderPointer].
///
...
/// Instance methods for [VNClustererBuilder] (Objective-C class `VNClustererBuilder`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/vision?language=objc](https://developer.apple.com/documentation/vision?language=objc)
extension VNClustererBuilderPointer on Pointer<VNClustererBuilder> {
  ...
  /// Objective-C method `updateModelByAddingFaces:andRemovingFaces:canceller:error:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `updateModelByAddingFaces:withGroupingIdentifiers:canceller:error:`.
  @ObjcMethodInfo(
    selector:
