...
/// Static methods for Objective-C class `VNFaceLandmarks3D`.
/// See also instance methods in [VNFaceLandmarks3DPointer].
///
...
/// Instance methods for [VNFaceLandmarks3D] (Objective-C class `VNFaceLandmarks3D`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/vision?language=objc](https://developer.apple.com/documentation/vision?language=objc)
