...
/// Static methods for Objective-C class `SKRequest`.
/// See also instance methods in [SKRequestPointer].
///
...
/// Instance methods for [SKRequest] (Objective-C class `SKRequest`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/storekit?language=objc](https://developer.apple.com/documentation/storekit?language=objc)
extension SKRequestPointer on Pointer<SKRequest> {
  ...
  /// Objective-C method `setPaymentQueueClient:`.
  @ObjcMethodInfo(
