...
/// Static methods for Objective-C class `WKAccessibilitySettingsObserver`.
/// See also instance methods in [WKAccessibilitySettingsObserverPointer].
///
...
/// Instance methods for [WKAccessibilitySettingsObserver] (Objective-C class `WKAccessibilitySettingsObserver`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/webkit?language=objc](https://developer.apple.com/documentation/webkit?language=objc)
extension WKAccessibilitySettingsObserverPointer
    on Pointer<WKAccessibilitySettingsObserver> {
  /// Objective-C method `initWithImpl:`.
  @ObjcMethodInfo(
