...
/// Static methods for Objective-C class `WKTextListTouchBarViewController`.
/// See also instance methods in [WKTextListTouchBarViewControllerPointer].
///
...
/// Instance methods for [WKTextListTouchBarViewController] (Objective-C class `WKTextListTouchBarViewController`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/webkit?language=objc](https://developer.apple.com/documentation/webkit?language=objc)
extension WKTextListTouchBarViewControllerPointer
    on Pointer<WKTextListTouchBarViewController> {
  /// Objective-C method `currentListType`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setCurrentListType:`.
  @ObjcMethodInfo(
