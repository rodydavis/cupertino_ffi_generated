...
/// Static methods for Objective-C class `WKNetworkSessionDelegate`.
/// See also instance methods in [WKNetworkSessionDelegatePointer].
///
...
/// Instance methods for [WKNetworkSessionDelegate] (Objective-C class `WKNetworkSessionDelegate`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/webkit?language=objc](https://developer.apple.com/documentation/webkit?language=objc)
extension WKNetworkSessionDelegatePointer on Pointer<WKNetworkSessionDelegate> {
  /// Objective-C method `URLSession:task:_schemeUpgraded:completionHandler:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:task:needNewBodyStream:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:task:didSendBodyData:totalBytesSent:totalBytesExpectedToSend:`.
  @ObjcMethodInfo(
    selector:
  ...
  /// Objective-C method `URLSession:task:didFinishCollectingMetrics:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:dataTask:didReceiveResponse:completionHandler:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:dataTask:didBecomeDownloadTask:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:dataTask:didReceiveData:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:dataTask:willCacheResponse:completionHandler:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:downloadTask:didFinishDownloadingToURL:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `URLSession:downloadTask:didWriteData:totalBytesWritten:totalBytesExpectedToWrite:`.
  @ObjcMethodInfo(
    selector:
  ...
  /// Objective-C method `URLSession:downloadTask:didResumeAtOffset:expectedTotalBytes:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `existingTask:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `initWithNetworkSession:withCredentials:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `sessionInvalidated`.
  @ObjcMethodInfo(
