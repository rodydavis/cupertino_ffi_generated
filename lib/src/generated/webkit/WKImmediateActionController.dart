...
/// Static methods for Objective-C class `WKImmediateActionController`.
/// See also instance methods in [WKImmediateActionControllerPointer].
///
...
/// Instance methods for [WKImmediateActionController] (Objective-C class `WKImmediateActionController`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/webkit?language=objc](https://developer.apple.com/documentation/webkit?language=objc)
extension WKImmediateActionControllerPointer
    on Pointer<WKImmediateActionController> {
  /// Objective-C method `didPerformImmediateActionHitTest:contentPreventsDefault:userData:`.
  @ObjcMethodInfo(
    selector:
  ...
  /// Objective-C method `dismissContentRelativeChildWindows`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `hasActiveImmediateAction`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `immediateActionRecognizerDidCancelAnimation:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `immediateActionRecognizerDidCompleteAnimation:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `immediateActionRecognizerDidUpdateAnimation:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `immediateActionRecognizerWillBeginAnimation:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `immediateActionRecognizerWillPrepare:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `initWithPage:view:viewImpl:recognizer:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `menuItemDidClose:`.
  @ObjcMethodInfo(
