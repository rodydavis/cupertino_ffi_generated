...
/// Static methods for Objective-C class `WKInspectorViewController`.
/// See also instance methods in [WKInspectorViewControllerPointer].
///
...
/// Instance methods for [WKInspectorViewController] (Objective-C class `WKInspectorViewController`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/webkit?language=objc](https://developer.apple.com/documentation/webkit?language=objc)
extension WKInspectorViewControllerPointer
  ...
  /// Objective-C method `initWithInspectedPage:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `inspectorWKWebView:willMoveToWindow:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `inspectorWKWebViewDidMoveToWindow:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `inspectorWKWebViewReload:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `inspectorWKWebViewReloadFromOrigin:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `webView:runOpenPanelWithParameters:initiatedByFrame:completionHandler:`.
  @ObjcMethodInfo(
    selector:
  ...
  /// Objective-C method `webViewWebContentProcessDidTerminate:`.
  @ObjcMethodInfo(
