...
/// Static methods for Objective-C class `WKWebView`.
/// See also instance methods in [WKWebViewPointer].
///
...
/// Instance methods for [WKWebView] (Objective-C class `WKWebView`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/webkit?language=objc](https://developer.apple.com/documentation/webkit?language=objc)
extension WKWebViewPointer on Pointer<WKWebView> {
  /// Objective-C method `UIDelegate`.
  @ObjcMethodInfo(
    selector: 'UIDelegate',
    returnType: '@',
    parameterTypes: ['@', ':'],
  ...
  /// Objective-C method `changeAttributes:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `documentContainerView`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `evaluateJavaScript:completionHandler:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `loadData:MIMEType:characterEncodingName:baseURL:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `loadFileURL:allowingReadAccessToURL:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `navigationDelegate`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setNavigationDelegate:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setUIDelegate:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `shareSheetDidDismiss:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `takeSnapshotWithConfiguration:completionHandler:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `typingAttributesWithCompletionHandler:`.
  @ObjcMethodInfo(
