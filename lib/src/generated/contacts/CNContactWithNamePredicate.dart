...
/// Static methods for Objective-C class `CNContactWithNamePredicate`.
/// See also instance methods in [CNContactWithNamePredicatePointer].
///
...
/// Instance methods for [CNContactWithNamePredicate] (Objective-C class `CNContactWithNamePredicate`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/contacts?language=objc](https://developer.apple.com/documentation/contacts?language=objc)
