...
/// Static methods for Objective-C class `CNContactRelationsDescription`.
/// See also instance methods in [CNContactRelationsDescriptionPointer].
///
...
/// Instance methods for [CNContactRelationsDescription] (Objective-C class `CNContactRelationsDescription`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/contacts?language=objc](https://developer.apple.com/documentation/contacts?language=objc)
