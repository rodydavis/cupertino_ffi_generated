...
/// Static methods for Objective-C class `CNPostalAddressesDescription`.
/// See also instance methods in [CNPostalAddressesDescriptionPointer].
///
...
/// Instance methods for [CNPostalAddressesDescription] (Objective-C class `CNPostalAddressesDescription`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/contacts?language=objc](https://developer.apple.com/documentation/contacts?language=objc)
