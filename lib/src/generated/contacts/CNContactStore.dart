...
/// Static methods for Objective-C class `CNContactStore`.
/// See also instance methods in [CNContactStorePointer].
///
...
/// Instance methods for [CNContactStore] (Objective-C class `CNContactStore`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/contacts?language=objc](https://developer.apple.com/documentation/contacts?language=objc)
extension CNContactStorePointer on Pointer<CNContactStore> {
  ...
  /// Objective-C method `contactWithMatchingDictionary:keysToFetch:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `contactsMatchingPropertiesOfContact:unifyResults:keysToFetch:error:`.
  @ObjcMethodInfo(
    selector:
  ...
  /// Objective-C method `enumerateContactsWithFetchRequest:error:usingBlock:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `executeFetchRequest:completion:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `initWithEnvironment:options:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `initWithEnvironment:options:managedConfiguration:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `unifiedContactWithIdentifier:keysToFetch:error:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `unifiedMeContactMatchingEmailAddress:keysToFetch:error:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `unifiedMeContactMatchingEmailAddresses:keysToFetch:error:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `unifiedMeContactWithKeysToFetch:error:`.
  @ObjcMethodInfo(
