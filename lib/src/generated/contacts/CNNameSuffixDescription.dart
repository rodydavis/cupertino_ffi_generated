...
/// Static methods for Objective-C class `CNNameSuffixDescription`.
/// See also instance methods in [CNNameSuffixDescriptionPointer].
///
...
/// Instance methods for [CNNameSuffixDescription] (Objective-C class `CNNameSuffixDescription`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/contacts?language=objc](https://developer.apple.com/documentation/contacts?language=objc)
