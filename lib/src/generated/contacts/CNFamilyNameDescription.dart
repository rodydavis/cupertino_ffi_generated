...
/// Static methods for Objective-C class `CNFamilyNameDescription`.
/// See also instance methods in [CNFamilyNameDescriptionPointer].
///
...
/// Instance methods for [CNFamilyNameDescription] (Objective-C class `CNFamilyNameDescription`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/contacts?language=objc](https://developer.apple.com/documentation/contacts?language=objc)
