...
/// Static methods for Objective-C class `CNSearchIndexDescription`.
/// See also instance methods in [CNSearchIndexDescriptionPointer].
///
...
/// Instance methods for [CNSearchIndexDescription] (Objective-C class `CNSearchIndexDescription`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/contacts?language=objc](https://developer.apple.com/documentation/contacts?language=objc)
