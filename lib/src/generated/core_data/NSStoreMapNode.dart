...
/// Static methods for Objective-C class `NSStoreMapNode`.
/// See also instance methods in [NSStoreMapNodePointer].
///
...
/// Instance methods for [NSStoreMapNode] (Objective-C class `NSStoreMapNode`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/coredata?language=objc](https://developer.apple.com/documentation/coredata?language=objc)
extension NSStoreMapNodePointer on Pointer<NSStoreMapNode> {
  ...
  /// Objective-C method `destinationsForRelationship:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setDestinations:forRelationship:`.
  @ObjcMethodInfo(
