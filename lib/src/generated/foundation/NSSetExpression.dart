...
/// Static methods for Objective-C class `NSSetExpression`.
/// See also instance methods in [NSSetExpressionPointer].
///
...
/// Instance methods for [NSSetExpression] (Objective-C class `NSSetExpression`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/foundation?language=objc](https://developer.apple.com/documentation/foundation?language=objc)
extension NSSetExpressionPointer on Pointer<NSSetExpression> {
  ...
  /// Objective-C method `initWithType:leftExpression:rightExpression:`.
  @ObjcMethodInfo(
