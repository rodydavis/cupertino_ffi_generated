...
/// Static methods for Objective-C class `NSPredicate`.
/// See also instance methods in [NSPredicatePointer].
///
...
/// Instance methods for [NSPredicate] (Objective-C class `NSPredicate`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/foundation?language=objc](https://developer.apple.com/documentation/foundation?language=objc)
extension NSPredicatePointer on Pointer<NSPredicate> {
  ...
  /// Objective-C method `predicateByAlsoMatchingNilValueForLeftExpression:modifier:`.
  @ObjcMethodInfo(
