...
/// Static methods for Objective-C class `NSISO8601DateFormatter`.
/// See also instance methods in [NSISO8601DateFormatterPointer].
///
...
/// Instance methods for [NSISO8601DateFormatter] (Objective-C class `NSISO8601DateFormatter`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/foundation?language=objc](https://developer.apple.com/documentation/foundation?language=objc)
extension NSISO8601DateFormatterPointer on Pointer<NSISO8601DateFormatter> {
  ...
  /// Objective-C method `formatOptions`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setFormatOptions:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `updateFormatter`.
  @ObjcMethodInfo(
