...
/// Static methods for Objective-C class `NSSubqueryExpression`.
/// See also instance methods in [NSSubqueryExpressionPointer].
///
...
/// Instance methods for [NSSubqueryExpression] (Objective-C class `NSSubqueryExpression`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/foundation?language=objc](https://developer.apple.com/documentation/foundation?language=objc)
extension NSSubqueryExpressionPointer on Pointer<NSSubqueryExpression> {
  ...
  /// Objective-C method `initWithExpression:usingIteratorVariable:predicate:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `initWithExpression:usingIteratorExpression:predicate:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `variableExpression`.
  @ObjcMethodInfo(
