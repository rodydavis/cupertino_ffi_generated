...
/// Static methods for Objective-C class `EKSuggestedEventPredicate`.
/// See also instance methods in [EKSuggestedEventPredicatePointer].
///
...
/// Instance methods for [EKSuggestedEventPredicate] (Objective-C class `EKSuggestedEventPredicate`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/cloudkit?language=objc](https://developer.apple.com/documentation/cloudkit?language=objc)
extension EKSuggestedEventPredicatePointer
  ...
  /// Objective-C method `initWithStartDate:endDate:opaqueKey:calendars:`.
  @ObjcMethodInfo(
  ...
  /// Objective-C method `setOpaqueKey:`.
  @ObjcMethodInfo(
