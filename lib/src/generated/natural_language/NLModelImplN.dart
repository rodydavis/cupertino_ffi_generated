...
/// Static methods for Objective-C class `NLModelImplN`.
/// See also instance methods in [NLModelImplNPointer].
///
...
/// Instance methods for [NLModelImplN] (Objective-C class `NLModelImplN`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/naturallanguage?language=objc](https://developer.apple.com/documentation/naturallanguage?language=objc)
extension NLModelImplNPointer on Pointer<NLModelImplN> {
  ...
  /// Objective-C method `predictedLabelsDictionaryForString:`.
  @ObjcMethodInfo(
