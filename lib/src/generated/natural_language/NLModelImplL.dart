...
/// Static methods for Objective-C class `NLModelImplL`.
/// See also instance methods in [NLModelImplLPointer].
///
...
/// Instance methods for [NLModelImplL] (Objective-C class `NLModelImplL`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/naturallanguage?language=objc](https://developer.apple.com/documentation/naturallanguage?language=objc)
extension NLModelImplLPointer on Pointer<NLModelImplL> {
  ...
  /// Objective-C method `initWithOwnedModelObject:configuration:labelMap:vocabularyMap:documentFrequencyMap:numberOfTrainingInstances:`.
  @ObjcMethodInfo(
    selector:
