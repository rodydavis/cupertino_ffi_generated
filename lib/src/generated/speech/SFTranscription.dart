...
/// Static methods for Objective-C class `SFTranscription`.
/// See also instance methods in [SFTranscriptionPointer].
///
...
/// Instance methods for [SFTranscription] (Objective-C class `SFTranscription`).
///
/// Find detailed documentation at: [developer.apple.com/documentation/speech?language=objc](https://developer.apple.com/documentation/speech?language=objc)
extension SFTranscriptionPointer on Pointer<SFTranscription> {
  ...
  /// Objective-C method `formattedString`.
  @ObjcMethodInfo(
